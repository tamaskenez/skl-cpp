#ifndef LABEL_INCLUDED_7928362394
#define LABEL_INCLUDED_7928362394
...
template<typename LabelType, typename EncodedType>
class LabelEncoder //public BaseEstimator, TransformerMixin
{
...
public:
    ...
    def fit(self, y):
        ...
        */
        ...
        return self
#endif
    std::vector<EncodedType> fit_transform(sx::array_view<const LabelType> y) {
        ...
        */
        ...
        for(auto&v: y) {
            yresult.push_back(
                std::lower_bound(BEGINEND(this->classes_), v) - this->classes_.begin()
            );
        }
        return yresult;
    }

    std::vector<EncodedType> transform(sx::array_view<const LabelType> y) const {
